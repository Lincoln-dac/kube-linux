...
func init() {
	...
	flannelFlags.IntVar(&opts.subnetLeaseRenewMargin, "subnet-lease-renew-margin", 60, "subnet lease renewal margin, in minutes, ranging from 1 to 10079")
...
func main() {
	...
	// Validate flags
	if opts.subnetLeaseRenewMargin >= 168*60 || opts.subnetLeaseRenewMargin <= 0 {
