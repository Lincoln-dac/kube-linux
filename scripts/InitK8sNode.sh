#!/bin/bash
# 定义基础URL变量
base_url="http://yum-repo.test.com"
...
InitNodeDir() {
    ...
    mkdir -p /nfsc/EDMS /data/EDMS /mall_admin /nfsc/epsp/custm/report /op_mount_data /epsp  /nfs /data/ADSP/exportArchive /tibet_internal/report /group1/M00/oa/fceformext /data/faceid/ /ailabmfs /data/adsp /group1/M00/oa/fceformext  || handle_error "创建其他目录失败"
}
